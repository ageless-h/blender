...
- [x] **任务说明**：补齐/对齐 Home/End、Ctrl+Backspace 等行为。
...
- [x] **任务说明**：优化 scrollback 追加与绘制策略，必要时引入节流/分页/折叠；并按一次执行聚合 INPUT/OUTPUT/ERROR。
...
- [x] **任务说明**：补齐 Windows/macOS/Linux 的差异记录，并在目标平台建立最小性能基线。
